...
public class Files extends AWebdavHandler{
     ...
     *
     * @param remotePath    Remotepath of the resource to query for server
    ...
    public ResourceProperties getProperties(String remotePath, boolean allProperties) throws IOException {
        ...
        try {
            Set<QName> props = getResourcePropertyConfigurations(allProperties);
            List<DavResource> resources = sardine.propfind(path, 0, props);
            if (resources != null && resources.size() == 1) {
                return parseProperties(resources.get(0));
            } else {
    ...
    public ResourceProperties parseProperties(DavResource res) {
    ...
    public static Set<QName> getResourcePropertyConfigurations(boolean allProperties) {
